                ...
                <div class="row justify-content-center align-items-center">
                    <div class="card" style="border-color: rebeccapurple;">
                        <div class="card-body" style="width: 360px;">
                            ...
                            <asp:Button ID="btn_login" runat="server" Text="Login" CssClass="btn-success form-control form-control-lg"
                                 Font-Size="14px"/>
                            <div class="divider">
                                <hr class="left">
                            ...
                            <div class="form-group">
                                <asp:Button ID="btn_contact" runat="server" Text="Contact Administrator" CssClass="btn-info form-control form-control-lg"
                                    Font-Size="14px" />
                            </div>
