<%@ Page Title="Product Menu" Language="C#" MasterPageFile="~/Dashboard/Dashboard.Master" AutoEventWireup="true" CodeBehind="Menu.aspx.cs" Inherits="WebApplication.Dashboard.Menu" MaintainScrollPositionOnPostback="true" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <asp:UpdatePanel ID="ProductUpdatePanel" runat="server">
            <ContentTemplate>
                <div class="card-body">
                    <div class="row">
                        <div class="col-sm-5">
                            <asp:DropDownList ID="LeftDropDownList" runat="server" AppendDataBoundItems="True" DataSourceID="MenuObjectDataSource" DataTextField="Name" DataValueField="ID" OnSelectedIndexChanged="LeftDropDownList_SelectedIndexChanged" AutoPostBack="True" CssClass="form-control">
                                <asp:ListItem Value="-1" Text="Uncategorized">Uncategorized</asp:ListItem>
                            </asp:DropDownList>
                            <hr />
                            <asp:CheckBoxList ID="LeftCheckBoxList" runat="server" DataTextField="Name" DataValueField="ID" CssClass="checkbox-list"></asp:CheckBoxList>
                        </div>
                        <div class="col-sm-2">
                            <asp:Button ID="MoveRight" runat="server" Text="Move Right" CssClass="btn btn-outline-primary w-100 mb-2" OnClick="MoveRight_OnClick" />
                            <br />
                            <asp:Button ID="MoveLeft" runat="server" Text="Move Left" CssClass="btn btn-outline-secondary w-100" OnClick="MoveLeft_OnClick" />
                        </div>
                        <div class="col-sm-5">
                            <asp:DropDownList ID="RightDropDownList" runat="server" AppendDataBoundItems="True" DataSourceID="MenuObjectDataSource" DataTextField="Name" DataValueField="ID" OnSelectedIndexChanged="RightDropDownList_SelectedIndexChanged" AutoPostBack="True" CssClass="form-control">
                                <asp:ListItem Value="0" Text="None">Select a Menu Category</asp:ListItem>
                            </asp:DropDownList>
                            <hr />
                            <asp:CheckBoxList ID="RightCheckBoxList" runat="server" CssClass="checkbox-list" DataValueField="ID" DataTextField="Name"></asp:CheckBoxList>
                        </div>
                    </div>
                </div>
            </ContentTemplate>
    ...
    <%-- Confirmation Modal --%>
    <asp:Panel ID="ConfirmationPanel" runat="server" CssClass="modal fade" role="dialog" TabIndex="-1" DefaultButton="ButtonModalDelete">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <asp:UpdatePanel ID="ConfirmationUpdatePanel" runat="server">
                    <ContentTemplate>
                        <div class="modal-header">
                            <h5 id="ConfirmModalHeader" runat="server" class="modal-title">Confirm Move</h5>
                            <button type="button" class="close" aria-label="Close" data-dismiss="modal">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        <div class="modal-body">
                            Are you sure you wish to move this item?    
                        </div>
                        <div class="modal-footer">
    ...
    <asp:Panel ID="DeletePanel" runat="server" CssClass="modal fade" role="dialog" TabIndex="-1" DefaultButton="ButtonModalDelete">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <asp:UpdatePanel ID="DeleteUpdatePanel" runat="server" >
                    <ContentTemplate>
                        <div class="modal-header">
    ...
    <asp:ObjectDataSource ID="MenuObjectDataSource" runat="server" DeleteMethod="DeleteMenu" InsertMethod="AddMenu" OldValuesParameterFormatString="original_{0}" SelectMethod="GetMenu" TypeName="DataAccessLayer.VelenicasRMSTableAdapters.MenusTableAdapter" UpdateMethod="UpdateMenu">
        <DeleteParameters>
            <asp:Parameter Name="ID" Type="Int32" />
        </DeleteParameters>
        <InsertParameters>
