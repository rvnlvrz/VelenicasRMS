<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="EditProductControl.ascx.cs" Inherits="WebApplication.UserControl.EditProductControl" %>

<div class="card mx-auto mb-3" style="width: 36rem;">
    <div class="card-body">
        <h5 class="card-title text-center">Edit Product</h5>
        <asp:FormView ID="FormEditItem" runat="server"></asp:FormView>
        <div class="row">
